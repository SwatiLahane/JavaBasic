...
//import methodOverloading_day07.MethodOverloading1;

public class Method_Overloading_basic {
	...
	static void Add()  //Static method
	  ...
	  {   
	   ...
	   public int Add(int ino1, int ino2,int ino3) //non static method
	  {
	...
	// main method from execution start from here
		  public static void main(String arg[]) 
		  {
			 ...
			 int ires3 = Add(20,30);
			  ...
			  Method_Overloading_basic mobj = new Method_Overloading_basic();
